...
#   provider = restapi.hosttech_dns
#   path = "/api/user/v1/zones/${var.hosttech-dns-zone-id}/records"
#   data = "{\"type\": \"A\",\"name\": \"ingress-${var.clustername}\",\"ipv4\": \"${data.kubernetes_service.ingress-nginx.status.0.load_balancer.0.ingress.0.ip}\",\"ttl\": 3600,\"comment\": \"Ingress Controller LB\"}"
#   id_attribute = "data/id"
# }
...
#   provider = restapi.hosttech_dns
#   path = "/api/user/v1/zones/${var.hosttech-dns-zone-id}/records"
#   data = "{\"type\": \"AAAA\",\"name\": \"ingress-${var.clustername}\",\"ipv6\": \"${data.kubernetes_service.ingress-nginx.status.0.load_balancer.0.ingress.1.ip}\",\"ttl\": 3600,\"comment\": \"Ingress Controller LB\"}"
#   id_attribute = "data/id"
# }